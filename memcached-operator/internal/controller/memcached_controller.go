...
const memcachedFinalizer = "cache.biwbass.xyz/finalizer"
...
//+kubebuilder:rbac:groups=cache.biwbass.xyz,resources=memcacheds,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=cache.biwbass.xyz,resources=memcacheds/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=cache.biwbass.xyz,resources=memcacheds/finalizers,verbs=update
